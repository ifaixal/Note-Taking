...
const {deleteNote, createNote, getNotes, getTagOfNote, getNotebyID, archieveNote, getArchieveNote, getTagOfArchieve, editNote, archieveEditNote} = require('../controllers/notesController');
