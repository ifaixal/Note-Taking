...
const BottomBar = () => {
    ...
    const [isLarge, setIsLarge] = useState(window.innerWidth > 375);

    useEffect(() => {
        const handleResize = () => setIsLarge(window.innerWidth > 375);
