  ...
  return (
    <div className='Editor'>
      <div className="titleTagsTimeWrapper">
        ...
        <div className="tagsTimeWrapper">
            <div className="tagsWrapper">
                ...
                <input type="text" name="" id="" placeholder='Add tags separated by commas (e.g. Planning, Work)'/>
            </div>
      ...
      <div className="editorNotesText">
        <textarea name="" id="NotesDescription" placeholder='Start typing your note here...' rows={25}></textarea>
      </div>
