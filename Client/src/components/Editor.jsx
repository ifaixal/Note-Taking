  ...
  const handleSubmit = async () => {
    ...
    try {
      const newNote = {
        ...
        content: description,
        tags: tagObjects,
        user: localStorage?.getItem("uid") // replace with real user when auth exists
      };
      console.log(newNote)
    ...
    <div className='Editor'>
      <div className="titleTagsTimeWrapper">
        <div className="titleWrapper">
            <input type="text" name="" id="" placeholder='Enter a title...' onChange={(e) => setTitle(e.target.value)}/>
        </div>
        ...
        <div className="tagsTimeWrapper">
            <div className="tagsWrapper">
                ...
                <input type="text" name="" id="" placeholder='Add tags separated by commas (e.g. Planning, Work)' onChange={handleTagsChange}/>
            </div>
      ...
      <div className="editorNotesText">
        <textarea required name="" id="NotesDescription" placeholder='Start typing your note here...' rows={25}  onChange={(e) => setDescription(e.target.value)}></textarea>
      </div>
