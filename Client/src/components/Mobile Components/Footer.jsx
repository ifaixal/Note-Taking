...
const Footer = () => {
  const { currentLinkMob, setCurrentLinkMob } = useNotes();

  return (
    <div className='Footer'>
      <div className={`Home${currentLinkMob === "Home" ? " active" : ""}`} onClick={() => setCurrentLinkMob("Home")}>
      ...
      <div className={`Search${currentLinkMob === "Search" ? " active" : ""}`} onClick={() => setCurrentLinkMob("Search")}>
      ...
      <div className={`Archieve${currentLinkMob === "Archieve" ? " active" : ""}`} onClick={() => setCurrentLinkMob("Archieve")}>
        ...
        <p className='FooterHeading'>Archieved</p>
      </div>

      <div className={`Tags${currentLinkMob === "Tags" ? " active" : ""}`} onClick={() => setCurrentLinkMob("Tags")}>
