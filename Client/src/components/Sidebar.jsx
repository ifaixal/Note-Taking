...
const TagsList = ({tags}) => {
  ...
  <div className="tagComponent">
      {tags.map((tag, index) => (
        <span key={index} className="tagList">
...
const SideBar = () => {
  const dummytags = ["Power", "ChatGPT"];   //Currently for testing purposes Only will be replaced later.
  const {selectedSection, setSelectedSection} = useNotes();
